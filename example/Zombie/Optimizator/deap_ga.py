...
evalQ.connect("tcp://172.16.142.104:5555")
outQ = context.socket(zmq.PAIR)
outQ.bind("tcp://172.16.15.43:5556")
# -----fine codice aggiunto per ZeroMQ----------

cpu_model="INIT_CPU::../example/Zombie/Simulation_Netlogo/cpu_script.sh::"
gpu_model="INIT_GPU::../example/Zombie/Simulation_Flame/gpu_script.sh::"
evalQ.send(str(len("INIT_OUT::tcp://172.16.15.43:5556::")))
evalQ.send("INIT_OUT::tcp://172.16.15.43:5556::")
